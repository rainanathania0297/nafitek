<template>
  <section
    id="about-section"
    class="py-20 lg:py-32 bg-charcoal relative overflow-hidden"
  >
    <!-- Background Elements -->
    ...
    <div class="container mx-auto px-4 lg:px-8">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
          ...
          >
            About
            <span class="text-gradient">{{ companyStore.companyName }}</span>
          </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div class="space-y-8">
            ...
            <div class="animate-fade-in-left">
              <h3
                class="text-2xl font-montserrat font-semibold text-white mb-4"
              >
                Our Story
              </h3>
              <template v-for="(item, index) in companyStore.companyData?.about" :key="index">
                <p :class="[
                  ...
                  index == companyStore.companyData?.about.length - 1 ? 'mb-0' : 'mb-6',
                ]">{{ item }}</p>
              </template>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <!-- Vision -->
              <div
                class="card-industrial animate-fade-in-left"
                style="animation-delay: 0.2s"
              >
                <div class="flex items-center mb-4">
                  <div
                    class="w-12 h-12 bg-golden rounded-lg flex items-center justify-center mr-4"
                  >
                    <Icon name="mdi:eye" class="w-6 h-6 text-charcoal" />
                  </div>
                  <h4 class="text-xl font-montserrat font-semibold text-white">
                    Vision
                  </h4>
                </div>
            ...
            <div class="animate-fade-in-left" style="animation-delay: 0.6s">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="text-center p-4 bg-gray-800/50 rounded-lg">
                  <div class="text-2xl font-bold text-golden mb-1">
                    <AnimatedCounter
                      :target="companyStore.companyStats?.client_total"
                      suffix="+"
                    />
                  </div>
                ...
                <div class="text-center p-4 bg-gray-800/50 rounded-lg">
                  <div class="text-2xl font-bold text-golden mb-1">
                    <AnimatedCounter
                      :target="companyStore.companyStats?.year_experience"
                      suffix="+"
                    />
                  </div>
          ...
          <div class="relative animate-fade-in-right">
            ...
            <div class="relative z-10">
              ...
              <!-- Overlay -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent rounded-2xl"
              ></div>
            </div>

            <!-- Floating Elements -->
            <div
              class="absolute -top-8 -left-8 w-24 h-24 bg-golden/20 rounded-full animate-float"
            ></div>
            <div
              class="absolute -bottom-8 -right-8 w-32 h-32 border-2 border-golden/30 rounded-full animate-float"
              style="animation-delay: 1s"
            ></div>

            <!-- Experience Badge -->
            <div
              class="absolute bottom-8 left-8 bg-charcoal/90 backdrop-blur-sm rounded-xl p-6 border border-golden/30 z-10"
            >
              <div class="text-center">
                <div class="text-3xl font-bold text-golden mb-1">
                  {{ companyStore.companyStats?.year_experience }}+
                </div>
            ...
            <!-- Gear Animation -->
            <div
              class="absolute top-8 right-8 w-16 h-16 opacity-30 animate-rotate-gear"
            >
